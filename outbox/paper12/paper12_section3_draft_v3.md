# Paper 12 §3 — The NP-Pump Nonlinearity: Dynamics on the Paper 9 Schur Circle (v3)

**Draft version:** v3 (2026-05-06, ~03:45 PDT)
...
**Revision summary (vs v2):** Phase-2 polish based on Opus's v2 residuals
(RES-3 Filippov $\lambda$ existence condition explicit; Remark 3.4.3
sharp-Heaviside apologia trimmed). Audit-runtime details consolidated
with verification-files block.

**Revision summary (vs v1, retained from v2):** All 11 v1 issues from Opus 4.7 review applied.
