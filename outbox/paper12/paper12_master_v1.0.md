...
abstract: |
  ...
  which both substrates accumulate topological residue through
  ...
  flow on Paper 9's $SO(2)$ Schur circle $[0, \pi/2]$, well-posed on an
  open dense parameter set, with five-stratum event structure
  ($\Sigma_{\mathrm{cross}}, \Sigma_{\mathrm{slide}}, \Sigma_{\mathrm{ext}},
  \Sigma_{\mathrm{degen}}, \Sigma_{\mathrm{rec}}$); (ii) a representation-
  ...
  Paper 12 is decisively falsified if any of P1–P4 fail at the binary
  thresholds specified in §5.6, or if Theorem 4.4.1's
...
**Master assembly v1.0 — 2026-05-06.**
...
**Tag at this assembly:** `paper12-v1.0-assembly`
...
**Status:** Body council-cleared (Opus 4.7 + GPT-5.5 + Gemini 3.1 Pro). Phase 2 polish applied. Front matter (§1, §2) drafted. Final full-paper council pass pending.
...
- [Paper 7] M. L. Graise, *Paper 7: Single-observer coherence ceiling (PCI Framework)*.
...
- [Costa-Pavone] D. R. Costa, M. Pavone (Sard transversality references; per §3 v3).
