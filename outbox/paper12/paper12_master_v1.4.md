...
**Master assembly v1.4 — 2026-05-08 — honest reframe of §5.7 superseding v1.3.** v1.3 published on Zenodo at [DOI: 10.5281/zenodo.20060751](https://doi.org/10.5281/zenodo.20060751); v1.4 corrects an overclaim in v1.3's §5.7 framing (see Erratum 5.7.0 below) and is the recommended citation.
...
**Tag at this assembly:** `paper12-v1.4-honest-reframe`. Earlier tags: `paper12-v1.0-assembly`, `paper12-v1.1-council-revised`, `paper12-v1.2-tensor-companion`, `paper12-v1.3-empirical-n1`, `paper12-v1.3-zenodo`, `paper12-v1.3-published`. v1.4 supersedes v1.3 by reframing §5.7 from "forensic analysis showing 8 / 8 quantitative predictions match" to "instrumentation specification with illustrative trajectory" — the v1.3 framing overstated what the example session established (see Erratum 5.7.0). The mathematics of §§3–4 is unchanged.
