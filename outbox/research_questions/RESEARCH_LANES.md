...
| L5 | Krasnov pure-connection G₂ Lagrangian / 8-coset sector | 🟢 OPEN — prompt drafted | web search | Could give the simulator (Paper 8) a continuum-field interpretation | His Lagrangian has a discrete sector matching our 8 cosets, or doesn't | prompt at `/inbox/for_chatgpt/2026-04-30_L5_krasnov_g2_continuum.md` |
...
| L7 | Wilting–Priesemann awake-cortex σ replication landscape | 🟢 OPEN — prompt drafted | web search | Determines whether σ ≈ 0.98 is the consensus or a specific lab's result | Find ≥3 independent labs reporting σ ≈ 0.98 in awake cortex with their methodology | prompt at `/inbox/for_chatgpt/2026-04-30_L7_wilting_priesemann_replication.md` |
