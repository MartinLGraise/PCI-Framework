...
| L3 | Oizumi 2024 principal bundle / IIT × G₂ | 🟢 OPEN — prompt drafted | GitHub connector + web search | Could open a Paper 11/12 IIT bridge OR rule out the connection cleanly | Either a structural map exists, or no compatible structure group exists, or Oizumi's bundle is incompatible | prompt at `/inbox/for_chatgpt/2026-04-30_L3_oizumi_iit_g2_bridge.md` |
